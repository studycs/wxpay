...
class WxPayUnifiedOrder extends WxPayDataBase
{
    ...
    /**
     * 获取APP和网页支付提交用户端ip，Native支付填调用微信支付API的机器IP。的mixed
     * @return mixed
     **/
    ...
    /**
     * 获取订单生成时间，格式为yyyyMMddHHmmss，如2009年12月25日9点10分10秒表示为20091225091010。其他详见时间规则的mixed
     * @return mixed
     **/
    ...
    /**
     * 获取订单失效时间，格式为yyyyMMddHHmmss，如2009年12月27日9点10分10秒表示为20091227091010。其他详见时间规则的mixed
     * @return mixed
     **/
    ...
    /**
     * 设置取mixed如下：JSAPI，NATIVE，APP，详细说明见参数规定
     * @param string $value
     **/
    ...
    /**
     * 获取取mixed如下：JSAPI，NATIVE，APP，详细说明见参数规定的mixed
     * @return mixed
     **/
    ...
    /**
     * 判断取mixed如下：JSAPI，NATIVE，APP，详细说明见参数规定是否存在
     * @return true 或 false
     **/
    ...
    /**
     * 获取trade_type=NATIVE，此参数必传。此id为二维码中包含的商品ID，商户自行定义。的mixed
     * @return mixed
     **/
    ...
    /**
     * 获取trade_type=JSAPI，此参数必传，用户在商户appid下的唯一标识。下单前需要调用【网页授权获取用户信息】接口获取到用户的Openid。 的mixed
     * @return mixed
     **/
